...
[前往 Lindorm 注册文档](https://help.aliyun.com/document_detail/2773369.html?spm=a2c4g.11186623.help-menu-172543.d_2_5_0.2a383f96gr5N3M&scm=20140722.H_2773369._.OR_help-T_cn~zh-V_1) 以注册 Lindorm 并生成 ak/sk。
...
有关所有 `LindormVectorStore` 功能和配置的详细文档，请前往 [API 参考](https://pypi.org/project/langchain-lindorm-integration/)。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\lindorm.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
