...
>[LanceDB](https://lancedb.com/) 是一个基于持久化存储构建的开源向量搜索数据库，极大地简化了嵌入的检索、过滤和管理。完全开源。
...
此外，要探索表，您可以将其加载到 df 中或保存为 csv 文件：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\lancedb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
