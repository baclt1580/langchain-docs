...
这里我们概述了将向量存储用作检索器的不同选项。

我们可以使用三种不同的搜索方法来执行检索。默认情况下，它将使用语义相似度。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\memorydb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
