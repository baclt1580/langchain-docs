...
请查看 [安装说明](https://neo4j.com/docs/operations-manual/current/installation/)。
...
Neo4j 向量存储还支持通过结合并行运行时和精确最近邻搜索来过滤元数据。_需要 Neo4j 5.18 或更高版本。_
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\neo4jvector.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
