---
title: "Lantern 集成"
description: "使用 LangChain Python 与 Lantern 向量存储库集成。"
---
...
上面，我们从头创建了一个向量存储库。然而，我们经常需要处理现有的向量存储库。为此，我们可以直接初始化它。
...
如果您有一个现有的集合，您可以通过执行 `from_documents` 并设置 `pre_delete_collection` = True 来覆盖它。这将在重新填充之前删除该集合。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\lantern.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
