...
[Tablestore](https://www.aliyun.com/product/ots) 是一项完全托管的 NoSQL 云数据库服务。

Tablestore 支持存储海量结构和半结构化数据。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\vectorstores\tablestore.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
