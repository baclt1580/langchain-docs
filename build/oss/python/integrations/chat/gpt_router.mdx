...
[GPTRouter](https://github.com/Writesonic/GPTRouter) 是一个开源的 LLM API 网关，为 30 多种 LLM、视觉和图像模型提供通用 API，具备基于正常运行时间和延迟的智能回退、自动重试和流式传输功能。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\chat\gpt_router.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
