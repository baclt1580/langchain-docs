...
需要有效的 [API 密钥](https://console.mistral.ai/api-keys/) 才能与 API 通信。获取密钥后，请设置 MISTRAL_API_KEY 环境变量：
...
请前往 [API 参考](https://reference.langchain.com/python/langchain-mistralai/chat_models/ChatMistralAI) 查看所有属性和方法的详细文档。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\chat\mistralai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
