...
本笔记本展示了如何将 LangChain 与 [LlamaAPI](https://llama-api.com/) 结合使用——这是一个托管版本的 Llama2，并增加了函数调用支持。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\chat\llama_api.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
