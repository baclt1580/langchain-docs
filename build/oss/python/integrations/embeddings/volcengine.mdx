---
title: "火山引擎集成"
description: "使用 LangChain Python 集成 Volc 引擎嵌入模型。"
---

本指南介绍了如何加载 Volcano Embedding 类。

## API 初始化

要使用基于 [VolcEngine](https://www.volcengine.com/docs/82379/1099455) 的 LLM 服务，您需要初始化以下参数：

您可以选择通过环境变量或初始化参数来初始化 AK、SK：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\embeddings\volcengine.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
