...
本笔记本介绍如何通过 [Infinity GitHub 项目](https://github.com/michaelfeil/infinity) 在 LangChain 中使用嵌入功能。
...
async def embed():
    ...
    # 重要：在 `async with` 语句中使用 engine 以启动/停止批处理引擎。
...
启动服务器 - 最好在单独的终端中执行，而不是在 Jupyter Notebook 内
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\embeddings\infinity.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
