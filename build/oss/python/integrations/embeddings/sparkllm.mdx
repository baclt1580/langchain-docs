...
使用该嵌入模型需要 API 密钥。您可以通过在 [platform.SparkLLM-ai.com/docs/text-Embedding](https://platform.SparkLLM-ai.com/docs/text-Embedding) 注册来获取一个。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\embeddings\sparkllm.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
