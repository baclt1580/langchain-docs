...
百度智能云千帆平台是一站式的大模型开发与服务运营平台，面向企业开发者。千帆不仅提供了包括文心一言（ERNIE-Bot）在内的模型以及第三方开源模型，还提供了多种AI开发工具和整套开发环境，方便客户轻松使用和开发大模型应用。
...
在本笔记中，我们将主要介绍如何在 `Embedding` 类型（对应于 langchain 中的 `langchain/embeddings` 包）中使用 LangChain 与 [千帆](https://cloud.baidu.com/doc/WENXINWORKSHOP/index.html)：
...
如果您希望基于文心大模型或第三方开源模型部署自己的模型，可以按照以下步骤操作：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\embeddings\baidu_qianfan_endpoint.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
