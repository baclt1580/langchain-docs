---
title: "使用优化和量化嵌入器集成嵌入文档"
description: "使用 LangChain Python 集成基于优化和量化嵌入器的文档嵌入模型。"
---

使用量化嵌入器嵌入所有文档。

这些嵌入器基于优化模型，通过结合 [optimum-intel](https://github.com/huggingface/optimum-intel.git) 和 [IPEX](https://github.com/intel/intel-extension-for-pytorch) 创建。
...
让我们提出一个问题，并与 2 个文档进行比较。第一个包含问题的答案，而第二个则不包含。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\embeddings\optimum_intel.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
