...
`langchain-scraperapi` 包提供了三个由 [ScraperAPI](https://www.scraperapi.com/) 服务支持的即用型 LangChain 工具：
...
通过 `/structured/amazon/search` 获取结构化产品结果。
...
以下是将工具用于 AI 代理的示例。`ScraperAPITool` 赋予 AI 浏览任何网站、总结文章以及点击链接在页面间导航的能力。
...
您可以在下方找到有关工具额外参数的更多信息，以自定义您的请求：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\scraperapi.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
