---
title: "Google 工作整合"
description: "使用 LangChain Python 集成 Google Jobs 工具。"
---

本笔记本介绍如何使用 Google Jobs 工具获取当前的职位发布。

首先，您需要在此处注册一个 `SerpApi key` 密钥：[serpapi.com/users/sign_up](https://serpapi.com/users/sign_up)，并在此处获取您的 API 密钥：[serpapi.com/manage-api-key](https://serpapi.com/manage-api-key)。
...
并使用 [`create_agent`](https://reference.langchain.com/python/langchain/agents/factory/create_agent) 功能初始化一个 ReAct 代理。您还需要设置您的 OPEN_API_KEY（访问 [platform.openai.com](https://platform.openai.com)）以访问 OpenAI 的聊天模型。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\google_jobs.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
