...
要使用此工具，您需要注册一个账户并从 [网站](https://scenex.jina.ai/api) 获取您的 API Token。然后您可以实例化该工具。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\sceneXplain.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
