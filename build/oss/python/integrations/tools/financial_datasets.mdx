...
[financial datasets](https://financialdatasets.ai/) 股票市场 API 提供 REST 端点，让您能够获取涵盖 30 多年、超过 16,000 个股票代码的金融数据。
...
让我们为智能体配备 FinancialDatasetsToolkit 并提出财务问题。
...
有关所有 `FinancialDatasetsToolkit` 功能和配置的详细文档，请前往 [API reference](https://reference.langchain.com/python/langchain-community/agent_toolkits/financial_datasets/toolkit/FinancialDatasetsToolkit)。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\financial_datasets.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
