...
本笔记本概述了如何在 LangChain 中直接使用 ADS4GPTs 工具和工具包。不过，在您的 LangGraph 应用中，您很可能会使用我们预构建的 LangGraph 代理。
...
初始化 ADS4GPTs 工具，例如 Ads4gptsInlineSponsoredResponseTool。我们将只使用一个工具，因为为我们提供的每个其他工具的处理过程都是相同的。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\ads4gpts.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
