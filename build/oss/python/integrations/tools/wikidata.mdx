---
title: "Wikidata 集成"
description: "使用 LangChain Python 与 维基数据 工具集成。"
---

>[维基数据](https://wikidata.org/) 是一个免费且开放的知识库，人类和机器都可以读取和编辑它。维基数据是世界上最大的开放知识库之一。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\wikidata.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
