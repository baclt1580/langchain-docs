...
本笔记本展示了如何使用 [Infobip](https://www.infobip.com/) API 包装器来发送短信、电子邮件。

Infobip 提供多种服务，但本笔记本将专注于短信和电子邮件服务。更多信息，请参阅 [API 和其他渠道](https://www.infobip.com/docs/api)。
...
- `infobip_api_key` - [API 密钥](https://www.infobip.com/docs/essentials/api-authentication#api-key-header)，您可以在您的 [开发者工具](https://portal.infobip.com/dev/api-keys) 中找到它
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\infobip.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
