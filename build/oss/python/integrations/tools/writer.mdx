...
本指南提供了开始使用 WRITER [工具](/oss/python/langchain/tools) 的概述。有关所有 WRITER 功能和配置的详细文档，请前往 [WRITER 文档](https://dev.writer.com/home)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\writer.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
