...
允许您从 LangChain 应用程序查询数据、管理记录并探索对象架构。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\salesforce.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
