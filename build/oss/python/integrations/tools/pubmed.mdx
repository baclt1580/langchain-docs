...
>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) 收录了来自 `MEDLINE`、生命科学期刊和在线书籍的超过 3500 万条生物医学文献引用。引用可能包含指向 PubMed Central 和出版商网站的全文内容链接。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\tools\pubmed.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
