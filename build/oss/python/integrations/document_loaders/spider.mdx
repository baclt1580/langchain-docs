...
[Spider](https://spider.cloud/) 是[最快](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md)且最经济的爬虫和抓取工具，能够返回适用于 LLM 的数据。
...
- `crawl`：爬取所提供域名 URL 下的所有子页面

## 爬虫选项

`params` 参数是一个字典，可以传递给加载器。查看 [Spider 文档](https://spider.cloud/docs/api) 以了解所有可用参数。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\spider.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
