...
本笔记本提供了快速入门 `PyPDF` [文档加载器](https://python.langchain.com/docs/concepts/document_loaders)的概述。有关所有 `DocumentLoader` 功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFLoader)。
...
在此模式下，PDF 按页面分割，生成的文档元数据包含页码。但在某些情况下，我们可能希望将 PDF 作为单个文本流处理（这样就不会将某些段落截断）。在这种情况下，您可以使用 *single* 模式：
...
### 添加自定义 *pages_delimiter* 以标识 *single* 模式中页面结束的位置
...
有关所有 `PyPDFLoader` 功能和配置的详细文档，请参阅 API 参考：[API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/pdf/PyPDFLoader)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\pypdfloader.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
