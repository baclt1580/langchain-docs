---
title: "Gutenberg 集成"
description: "使用 LangChain Python 与 Gutenberg 文档加载器集成。"
---
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\gutenberg.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
