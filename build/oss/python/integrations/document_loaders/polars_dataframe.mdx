...
本笔记本介绍了如何从 [polars](https://pola-rs.github.io/polars-book/user-guide/) DataFrame 加载数据。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\polars_dataframe.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
