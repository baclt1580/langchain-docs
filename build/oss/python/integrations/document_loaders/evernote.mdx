...
>[EverNote](https://evernote.com/) 旨在用于归档和创建笔记，可以嵌入照片、音频和保存的网页内容。笔记存储在虚拟的“笔记本”中，可以进行标记、注释、编辑、搜索和导出。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\evernote.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
