...
一个位于以下三个预览区域之一的 Azure AI 文档智能资源：**美国东部**、**美国西部 2**、**西欧**——如果你还没有，请按照[此文档](https://learn.microsoft.com/azure/ai-services/document-intelligence/create-document-intelligence-resource?view=doc-intel-4.0.0)创建一个。你将把 `<endpoint>` 和 `<key>` 作为参数传递给加载器。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\microsoft_excel.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
