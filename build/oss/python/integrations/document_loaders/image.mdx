...
本文介绍如何将图像加载到可供下游其他 LangChain 模块使用的文档格式中。

它使用 [Unstructured](https://unstructured.io/) 来处理多种图像格式，例如 `.jpg` 和 `.png`。有关在本地设置 Unstructured 的更多说明，包括设置必需的系统依赖项，请参阅 [Unstructured](/oss/python/integrations/providers/unstructured/)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\image.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
