...
`AsyncHtmlLoader` 可从一组 URL 并发加载原始 HTML 内容。
...
# 如果你需要通过代理进行网络请求，例如使用 http_proxy/https_proxy 环境变量，
...
```text
获取页面: 100%|############| 2/2 [00:00<00:00,  9.96it/s]
```
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\document_loaders\async_html.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
