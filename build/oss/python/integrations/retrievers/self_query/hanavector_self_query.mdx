...
为了能够以良好的性能进行自查询，我们在 HANA 的向量存储表中创建了额外的元数据字段：
...
现在进入正题：以下是为 HANA 向量存储构建 SelfQueryRetriever 的方法：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\self_query\hanavector_self_query.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
