...
> [LLMLingua](https://github.com/microsoft/LLMLingua) 利用紧凑且训练良好的语言模型（例如 GPT2-small、LLaMA-7B）来识别并移除提示词中的非关键令牌。这种方法使得大型语言模型（LLM）能够进行高效推理，实现高达 20 倍的压缩率，同时性能损失极小。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\llmlingua.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
