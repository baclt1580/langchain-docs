...
Perigon API 套件提供快速、结构化的全球新闻和事件访问权限，帮助您构建实时、数据驱动的产品。无论您是在追踪新兴风险、展示相关文章，还是挖掘关键见解，Perigon 都为您提供编程实现这些功能的工具。

与传统基于关键词的搜索不同，Perigon 的语义搜索功能使其能够上下文理解查询并返回相关文档。

本笔记本演示了如何在 LangChain 中使用 Perigon 的检索器来处理新闻文章和维基百科内容。
...
您需要一个 Perigon API 密钥才能使用此集成。在 [Perigon.io](https://perigon.io/) 注册以获取您的 API 密钥。
...
WikipediaRetriever 提供对维基百科内容的语义搜索功能，并带有丰富的元数据：
...
有关所有 Perigon API 功能和配置的详细文档，请访问 [Perigon API documentation](https://dev.perigon.io/docs)。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\perigon.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
