---
title: "Kinetica 基于向量存储的检索器集成"
description: "使用 LangChain Python 集成 Kinetica 基于向量存储的检索器。"
---

[Kinetica](https://www.kinetica.com/) 是一个内置支持向量相似度搜索的数据库。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\kinetica.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
