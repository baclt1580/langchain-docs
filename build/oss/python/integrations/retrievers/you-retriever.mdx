...
>[you.com API](https://api.you.com) 是一套旨在帮助开发者将 LLM 的输出基于其训练数据集中可能未包含的最新、最准确、最相关的信息的工具套件。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\you-retriever.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
