...
我们可以将其用作 [检索器](/oss/python/langchain/retrieval)。它将展示此集成的特定功能。完成后，探索 [相关用例页面](/oss/python/langchain/rag) 以了解如何将此向量存储作为更大链的一部分使用可能会有所帮助。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\retrievers\tavily.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
