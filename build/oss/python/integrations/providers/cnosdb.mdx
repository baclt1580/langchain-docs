...
> [CnosDB](https://github.com/cnosdb/cnosdb) 是一个开源的分布式时序数据库，具有高性能、高压缩率和易用性。
...
### SQL 数据库链
此示例演示了如何使用 SQL Chain 回答关于 CnosDB 的问题。
```python
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\providers\cnosdb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
