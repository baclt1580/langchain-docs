...
## 嵌入
下面的代码片段展示了如何使用 Isaacus 的 Kanon 2 Embedder 模型配合 LangChain 评估法律查询与法律文档之间的语义相似度。有关如何使用 Isaacus LangChain 集成生成嵌入的更详细指南，请参阅 [Isaacus 嵌入指南](/oss/python/integrations/embeddings/isaacus)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\providers\isaacus.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
