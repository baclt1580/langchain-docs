...
要使用 Clarifai，您必须拥有账户和个人访问令牌 (PAT) 密钥。
[检查此处](https://clarifai.com/settings/security) 以获取或创建 PAT。
...
我们将在此处设置个人访问令牌。您可以在 Clarifai 账户的 [settings/security](https://clarifai.com/settings/security) 下找到您的 PAT。
...
您还需要初始化模型 ID，如果需要的话，还有模型版本 ID。某些模型有多个版本，您可以选择适合您任务的版本。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\clarifai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
