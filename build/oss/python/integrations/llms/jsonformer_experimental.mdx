...
它通过填充结构 token，然后从模型中采样内容 token 来工作。
...
***那不是很令人印象深刻，对吧？它完全没有遵循 JSON 格式！让我们尝试使用结构化解码器。***
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\jsonformer_experimental.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
