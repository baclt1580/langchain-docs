...
description: "使用 LangChain Python 与 Javelin AI 网关教程 LLM 进行集成。"
---

本 Jupyter Notebook 将探索如何使用 Python SDK 与 Javelin AI 网关进行交互。
Javelin AI 网关通过提供安全统一的端点，促进了大型语言模型（LLM）如 OpenAI、Cohere、Anthropic 等的利用。网关本身提供了一个集中机制，用于系统性地部署模型，
为企业提供访问安全、策略和成本护栏等，

有关 Javelin 所有功能及优势的完整列表，请访问 [www.getjavelin.io](https://www.getjavelin.io)

## 步骤 1：简介

[Javelin AI 网关](https://www.getjavelin.io) 是一个面向 AI 应用的企业级 API 网关。它集成了强大的访问安全性，确保与大型语言模型的安全交互。更多信息请查看 [官方文档](https://docs.getjavelin.io)。
...
本节将演示如何与 Javelin AI 网关交互以从大型语言模型获取补全。以下是一个演示此操作的 Python 脚本：
...
本节演示如何使用 Javelin AI 网关为文本查询和文档获取嵌入。以下是一个说明此操作的 Python 脚本：
...
本节说明了如何与 Javelin AI 网关交互以促进与大型语言模型的聊天。以下是一个演示此操作的 Python 脚本：
...
记得查看 Javelin [Python SDK](https://www.github.com/getjavelin.io/javelin-python) 获取更多示例，并查阅官方文档了解更多详情。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\javelin.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
