---
title: "火山引擎 MaaS 集成"
description: "使用 LangChain Python 集成火山引擎 MaaS LLM。"
---

本指南将为您介绍如何开始使用火山引擎的 MaaS LLM 模型。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\volcengine_maas.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
