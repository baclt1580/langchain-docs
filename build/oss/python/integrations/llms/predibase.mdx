...
[Predibase](https://predibase.com/) 允许您训练、微调并部署任何机器学习模型——从线性回归到大型语言模型。

本示例演示了在 Predibase 上部署的模型上使用 LangChain。
...
## 微调 LLM（使用您自己的来自 Predibase 的微调 LLM）
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\predibase.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
