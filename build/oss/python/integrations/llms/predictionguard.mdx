...
>[Prediction Guard](https://predictionguard.com) 是一个安全、可扩展的生成式 AI 平台，可保护敏感数据，防止常见的 AI 故障，并在廉价硬件上运行。

## 概述

### 集成详情

此集成利用 Prediction Guard API，其中包括各种防护和安全功能。
...
使用 Prediction Guard，您可以使用我们的输入检查之一来保护您的模型输入免受 PII 或提示注入的影响。有关更多信息，请参阅 [Prediction Guard 文档](https://docs.predictionguard.com/docs/process-llm-input/)。
...
使用 Prediction Guard，您可以使用事实性来检查验证模型输出，以防止幻觉和错误信息，并使用毒性检测来防止有毒响应（例如粗俗语言、仇恨言论）。有关更多信息，请参阅 [Prediction Guard 文档](https://docs.predictionguard.com/docs/validating-llm-output)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\predictionguard.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
