...
[Nebula](https://symbl.ai/nebula/) 是由 [Symbl.ai](https://symbl.ai) 构建的大型语言模型（LLM）。它经过训练，可执行人类对话上的生成任务。Nebula 擅长建模对话的细微细节，并执行对话相关任务。

Nebula 文档：[docs.symbl.ai/docs/nebula-llm](https://docs.symbl.ai/docs/nebula-llm)

本示例介绍如何使用 LangChain 与 [Nebula platform](https://docs.symbl.ai/docs/nebula-llm) 进行交互。

请确保您已准备好 API Key。如果您没有，请 [request one](https://info.symbl.ai/Nebula_Private_Beta.html)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\python\integrations\llms\symblai_nebula.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
