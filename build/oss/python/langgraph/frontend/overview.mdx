...
[LangChain 前端模式](/oss/python/langchain/frontend/overview)——如 Markdown 消息、工具调用、乐观更新等——可与任何 LangGraph 图配合使用。无论您使用 `createAgent`、`createDeepAgent` 还是自定义的 `StateGraph`，`useStream` 钩子都提供相同的核心 API。
