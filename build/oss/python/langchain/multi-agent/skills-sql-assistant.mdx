...
<Note>
**生产注意事项**：本教程为了简单起见在 `__init__` 中加载技能列表。在生产系统中，您可能希望在 `before_agent` 钩子中加载技能，以便定期刷新它们以反映最新更改（例如，当添加新技能或修改现有技能时）。有关详细信息，请参阅 [before_agent 钩子文档](/oss/python/langchain/middleware/custom#node-style-hooks)。
</Note>
