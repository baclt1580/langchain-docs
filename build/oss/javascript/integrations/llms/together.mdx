---
title: "TogetherAI 集成"
description: "使用 LangChain JavaScript 集成 TogetherAI 大语言模型。"
---

<Warning>
**您当前浏览的页面是 Together AI 模型作为文本补全模型的文档。Together AI 上提供的许多热门模型是[聊天补全模型](/oss/javascript/langchain/models)。**

您可能正在寻找[此页面](/oss/javascript/integrations/chat/togetherai/)。
</Warning>

[Together AI](https://www.together.ai/) 提供了一个 API，只需几行代码即可查询[50多个领先的开源模型](https://docs.together.ai/docs/inference-models)。

本文将帮助您使用 LangChain 开始使用 Together AI 文本补全模型（LLMs）。有关 `TogetherAI` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/llms/togetherai/TogetherAI)。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\llms\together.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
