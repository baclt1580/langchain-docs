...
title: "向量存储集成"
sidebarTitle: "向量存储"
description: "使用 LangChain JavaScript 与向量存储集成。"
---
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\vectorstores\index.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
