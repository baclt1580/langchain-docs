...
本指南提供了快速入门 Chroma [向量存储](/oss/javascript/integrations/vectorstores) 的概览。有关 `Chroma` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/vectorstores/chroma/Chroma)。

<Info>
**Chroma Cloud**

Chroma Cloud 提供无服务器向量和全文搜索功能。它极其快速、经济高效、可扩展且易于使用。创建数据库并在 30 秒内使用 5 美元免费额度进行试用。
...
| :--- | :--- | :---: | :---: |
| [`Chroma`](https://reference.langchain.com/javascript/langchain-community/vectorstores/chroma/Chroma) | [`@langchain/community`](https://www.npmjs.com/package/@langchain/community) | ✅ |  ![NPM - 版本](https://img.shields.io/npm/v/@langchain/community?style=flat-square&label=%20&) |
...
如果你想在本地运行 Chroma，可以使用 Chroma CLI（随 `chromadb` 包提供）[运行本地 Chroma 服务器](https://docs.trychroma.com/docs/cli/run)：
...
如果你想获取模型调用的自动化追踪，也可以设置你的 [LangSmith](/langsmith/home) API 密钥，取消以下注释即可：
...
简单的 `Chroma` 实例化将连接到运行在 `http://localhost:8000` 的本地 Chroma 服务器：
...
有关 `Chroma` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/vectorstores/chroma/Chroma)

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\vectorstores\chroma.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
