...
LanceDB 是一个面向 AI 应用的嵌入式向量数据库。它是开源的，采用 Apache-2.0 许可证分发。

LanceDB 数据集持久化到磁盘，并可在 Node.js 和 Python 之间共享。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\vectorstores\lancedb.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
