...
本笔记本介绍了如何使用 [`SitemapLoader`](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/sitemap/SitemapLoader) 类将站点地图加载到 `Document` 中。
...
传入的 URL 必须包含站点地图的 `.xml` 路径，否则系统会自动在 URL 后追加默认的 `/sitemap.xml`。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\document_loaders\web_loaders\sitemap.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
