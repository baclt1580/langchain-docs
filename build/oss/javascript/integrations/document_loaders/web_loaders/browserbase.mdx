...
- 从 [browserbase.com](https://browserbase.com) 获取 API 密钥和项目 ID，并在环境变量中设置（`BROWSERBASE_API_KEY`、`BROWSERBASE_PROJECT_ID`）。
...
按如下方式使用 `BrowserbaseLoader`，使您的代理能够加载网站：
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\document_loaders\web_loaders\browserbase.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
