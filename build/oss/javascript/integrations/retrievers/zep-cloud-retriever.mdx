...
<Tip>
通用安装 LangChain 包的说明请参见 [此部分](/oss/javascript/langchain/install)。
</Tip>
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\retrievers\zep-cloud-retriever.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
