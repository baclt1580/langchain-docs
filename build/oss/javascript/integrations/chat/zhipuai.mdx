...
description: "使用 LangChain JavaScript 集成 ChatZhipuAI 聊天模型。"
---
...
你需要注册获取智谱 API 密钥，并将其设置为名为 `ZHIPUAI_API_KEY` 的环境变量。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\chat\zhipuai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
