---
title: "模拟集成"
description: "使用 LangChain JavaScript 与模拟聊天模型集成。"
---
...
/**
 * FakeListChatModel 可用于模拟预定义的顺序响应。
 */
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\chat\fake.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
