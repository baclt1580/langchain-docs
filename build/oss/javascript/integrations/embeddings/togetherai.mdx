...
本文将帮助您开始使用 LangChain 的 TogetherAIEmbeddings [嵌入模型](/oss/javascript/integrations/embeddings)。关于 `TogetherAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/embeddings/togetherai/TogetherAIEmbeddings)。
...
您可以[注册 Together 账户并创建 API 密钥](https://api.together.xyz/)。完成此操作后，请设置 `TOGETHER_AI_API_KEY` 环境变量：
...
您可以使用 `embedQuery` 嵌入查询以进行搜索。这会生成针对查询的向量表示：
...
关于 `TogetherAIEmbeddings` 所有功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/javascript/langchain-community/embeddings/togetherai/TogetherAIEmbeddings)。

---

<div className="source-links">
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\oss\javascript\integrations\embeddings\togetherai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
