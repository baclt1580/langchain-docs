...
<Note>
    深度智能体需要一个支持 [工具调用](/oss/javascript/langchain/models#tool-calling) 的模型。有关如何配置你的模型，请参阅 [自定义](/oss/javascript/deepagents/customization#model)。
</Note>
...
深度智能体内置了 [流式传输](/oss/javascript/langchain/streaming/overview) 功能，可通过 LangGraph 实时更新智能体执行状态。
