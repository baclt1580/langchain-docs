...
sidebarTitle: 分布式追踪
description: 当您从另一个服务调用已部署的 Agent Server 时，可以传播追踪上下文，使整个请求在 LangSmith 中显示为单个统一的追踪。这利用了 LangSmith 的 [分布式追踪](/langsmith/distributed-tracing) 功能，该功能通过 HTTP 头传播上下文。
---
