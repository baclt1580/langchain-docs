---
title: 本地开发与测试
description: 比较 langgraph dev 和 langgraph up 在本地开发和生产环境测试 Agent Server 应用时的不同用途。
icon: "device-laptop"
---
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\langsmith\local-dev-testing.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
