...
助手建立在 LangGraph 开源的[配置](/oss/python/langgraph/graph-api#runtime-context)概念之上。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\langsmith\assistants.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
