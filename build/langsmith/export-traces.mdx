...
<Tip>
    **使用 LangGraph 在本地重放追踪记录**
    ...
    如果你在使用带检查点（checkpointing）功能的 LangGraph，可以从 LangSmith 获取追踪记录并在本地重放以进行调试。有关从检查点恢复执行的详细信息，请参阅 [LangGraph 的时间旅行与重放文档](/oss/python/langgraph/use-time-travel)。
</Tip>
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\langsmith\export-traces.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
