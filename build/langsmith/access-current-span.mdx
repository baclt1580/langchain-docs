...
在某些情况下，你可能希望在追踪函数中访问当前运行（span）。这对于从当前运行中提取 UUID、标签或其他信息非常有用。

你可以通过调用 Python 或 TypeScript SDK 中的 `get_current_run_tree`/`getCurrentRunTree` 函数来访问当前运行。
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/i18n\zh-CN\langsmith\access-current-span.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
