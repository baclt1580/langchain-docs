...
您可以在标准检索管道中使用 [`ExaSearchRetriever`](/oss/integrations/tools/exa_search#using-exasearchretriever)。您可以按如下方式导入它。
...
您可以像 [Exa 工具调用文档](/oss/integrations/tools/exa_search#use-within-an-agent) 中描述的那样，将 Exa 用作代理工具。
