...
下面是展示如何在 Discord 中读取和发送消息的代码片段。更多详细信息，请参阅 [Discord 工具的文档](/oss/integrations/tools/discord)。
...
`DiscordToolkit` 将多个与 Discord 相关的工具组合到一个单一接口中。有关使用示例，请参阅 [Discord 工具包文档](/oss/integrations/tools/discord)。
