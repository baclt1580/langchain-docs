...
有关 Pinecone 向量存储的详细逐步指南，请参阅 [此笔记本](/oss/integrations/vectorstores/pinecone)
...
有关更详细的逐步指南，请参阅 [Pinecone 稀疏向量存储笔记本](/oss/integrations/vectorstores/pinecone_sparse)。
...
有关更多详细用法，请参阅 [Pinecone 稀疏嵌入笔记本](/oss/integrations/vectorstores/pinecone_sparse)。
...
有关更多信息，请参阅 [此笔记本](/oss/integrations/retrievers/pinecone_hybrid_search)。
