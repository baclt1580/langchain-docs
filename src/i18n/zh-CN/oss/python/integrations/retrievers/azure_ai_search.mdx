...
本指南将帮助您开始使用 Azure AI 搜索 [检索器](/oss/langchain/retrieval)。有关所有 `AzureAISearchRetriever` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-community/retrievers/azure_ai_search/AzureAISearchRetriever)。
