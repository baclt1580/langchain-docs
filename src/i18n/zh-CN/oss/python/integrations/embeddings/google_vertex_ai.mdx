...
<Danger>
    **已弃用**
    ...
    此集成已弃用，将在未来版本中移除。请改用 [`GoogleGenerativeAIEmbeddings`](/oss/integrations/embeddings/google_generative_ai)。查看完整的[发布说明和迁移指南](https://github.com/langchain-ai/langchain-google/discussions/1422)。
</Danger>
