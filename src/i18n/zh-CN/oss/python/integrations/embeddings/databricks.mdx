...
本指南提供了快速入门 `DatabricksEmbeddings` [嵌入模型](/oss/integrations/embeddings) 的概述。有关 `DatabricksEmbeddings` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/embeddings/databricks/DatabricksEmbeddings)。
