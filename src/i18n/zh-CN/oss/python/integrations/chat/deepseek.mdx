...
本文将帮助您开始使用 DeepSeek 托管的[聊天模型](/oss/langchain/models)。
...
<Tip>
    **DeepSeek 的模型是开源的，也可以在本地运行（例如在 [Ollama](/oss/integrations/chat/ollama) 中）或其他推理提供商上运行（例如 [Fireworks](/oss/integrations/chat/fireworks)、[Together](/oss/integrations/chat/together)）。**
</Tip>
