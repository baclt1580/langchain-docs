...
<Warning>
    本页面涉及 [Groq](https://console.groq.com/docs/overview)，一家 AI 硬件和软件公司。关于如何使用 Grok 模型（由 [xAI](https://docs.x.ai/docs/overview) 提供）的信息，请参阅 [xAI 供应商页面](/oss/integrations/providers/xai)。
</Warning>
