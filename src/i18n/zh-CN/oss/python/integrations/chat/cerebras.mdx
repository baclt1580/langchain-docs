...
本指南提供了快速入门 Cerebras [聊天模型](/oss/langchain/models) 的概述。有关 `ChatCerebras` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-cerebras/chat_models/ChatCerebras)。
