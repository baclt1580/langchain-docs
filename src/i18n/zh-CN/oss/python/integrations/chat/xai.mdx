...
<Warning>
    本页面提及由 [xAI](https://docs.x.ai/docs/overview) 提供的 Grok 模型——请勿与另一家 AI 硬件和软件公司 [Groq](https://console.groq.com/docs/overview) 混淆。详见 [Groq 供应商页面](/oss/integrations/providers/groq)。
</Warning>
...
<Tip>
    **API 参考**
    ...
    有关所有功能和配置选项的详细文档，请查阅 @[`ChatXAI`] API 参考。
</Tip>
...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output) | [图像输入](/oss/langchain/messages#multimodal) | 音频输入 | 视频输入 | [令牌级流式传输](/oss/langchain/streaming#llm-tokens) | 原生异步 | [令牌用量](/oss/langchain/models#token-usage) | [对数概率](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | ❌ | ✅ | ✅ |
