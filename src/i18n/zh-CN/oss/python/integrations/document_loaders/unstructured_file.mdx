...
本笔记本介绍了如何使用 Unstructured [文档加载器](/oss/integrations/document_loaders) 来加载多种类型的文件。`Unstructured` 目前支持加载文本文件、PowerPoint、HTML、PDF、图像等多种格式。

有关在本地设置 Unstructured 的更多说明，包括设置所需的系统依赖项，请参阅 [Unstructured](/oss/integrations/providers/unstructured)。
