...
文档加载器提供了一个**标准接口**，用于从不同来源（如 Slack、Notion 或 Google Drive）读取数据并转换为 LangChain 的 @[Document] 格式。
这确保了无论数据来源如何，数据都能得到一致的处理。
...
| [RecursiveURL](/oss/integrations/document_loaders/recursive_url) | 递归抓取根 URL 下的所有子链接 | 包 |
| [Sitemap](/oss/integrations/document_loaders/sitemap) | 抓取给定站点地图上的所有页面 | 包 |
| [Spider](/oss/integrations/document_loaders/spider) | 返回 LLM 就绪数据的爬虫和刮取器 | API |
| [Firecrawl](/oss/integrations/document_loaders/firecrawl) | 可本地部署的 API 服务 | API |
| [Apify Dataset](/oss/integrations/document_loaders/apify_dataset) | 从 Apify 数据集加载文档 | API |
| [Docling](/oss/integrations/document_loaders/docling) | 使用 Docling 加载和解析网页 | 包 |
| [Hyperbrowser](/oss/integrations/document_loaders/hyperbrowser) | 运行和扩展无头浏览器的平台，可用于抓取/爬取任何网站 | API |
| [AgentQL](/oss/integrations/document_loaders/agentql) | 使用 AgentQL 查询或自然语言提示进行网页交互和结构化数据提取 | API |
...
|----------------|-------------|----------------|---------------|
| [AWS S3 Directory](/oss/integrations/document_loaders/aws_s3_directory) | 从 AWS S3 目录加载文档 | ❌ | [`S3DirectoryLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/s3_directory/S3DirectoryLoader) |
| [AWS S3 File](/oss/integrations/document_loaders/aws_s3_file) | 从 AWS S3 文件加载文档 | ❌ | [`S3FileLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/s3_file/S3FileLoader) |
| [Azure AI Data](/oss/integrations/document_loaders/azure_ai_data) | 从 Azure AI 服务加载文档 | ❌ | [`AzureAIDataLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/azure_ai_data/AzureAIDataLoader) |
...
| [Dropbox](/oss/integrations/document_loaders/dropbox) | 从 Dropbox 加载文档 | ❌ | [`DropboxLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/dropbox/DropboxLoader) |
| [Google Cloud Storage Directory](/oss/integrations/document_loaders/google_cloud_storage_directory) | 从 GCS 存储桶加载文档 | ✅ | [`GCSDirectoryLoader`](https://reference.langchain.com/python/langchain-google-community/gcs_directory/GCSDirectoryLoader) |
...
| [Google Drive](/oss/integrations/document_loaders/google_drive) | 从 Google Drive 加载文档（仅限 Google Docs） | ✅ | [`GoogleDriveLoader`](https://reference.langchain.com/python/langchain-google-community/drive/GoogleDriveLoader) |
| [Huawei OBS Directory](/oss/integrations/document_loaders/huawei_obs_directory) | 从华为对象存储服务目录加载文档 | ❌ | [`OBSDirectoryLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/obs_directory/OBSDirectoryLoader) |
| [Huawei OBS File](/oss/integrations/document_loaders/huawei_obs_file) | 从华为对象存储服务文件加载文档 | ❌ | [`OBSFileLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/obs_file/OBSFileLoader) |
| [Microsoft OneDrive](/oss/integrations/document_loaders/microsoft_onedrive) | 从 Microsoft OneDrive 加载文档 | ❌ | [`OneDriveLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/onedrive/OneDriveLoader) |
| [Microsoft SharePoint](/oss/integrations/document_loaders/microsoft_sharepoint) | 从 Microsoft SharePoint 加载文档 | ❌ | [`SharePointLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/sharepoint/SharePointLoader) |
| [Tencent COS Directory](/oss/integrations/document_loaders/tencent_cos_directory) | 从腾讯云对象存储目录加载文档 | ❌ | [`TencentCOSDirectoryLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/tencent_cos_directory/TencentCOSDirectoryLoader) |
| [Tencent COS File](/oss/integrations/document_loaders/tencent_cos_file) | 从腾讯云对象存储文件加载文档 | ❌ | [`TencentCOSFileLoader`](https://reference.langchain.com/python/langchain-community/document_loaders/tencent_cos_file/TencentCOSFileLoader) |
...
| [`Unstructured`](/oss/integrations/document_loaders/unstructured_file) | 多种文件类型（见 https://docs.unstructured.io/platform/supported-file-types） |
| [`JSONLoader`](/oss/integrations/document_loaders/json) | JSON 文件 |
| [`BSHTMLLoader`](/oss/integrations/document_loaders/bshtml) | HTML 文件 |
| [`DoclingLoader`](/oss/integrations/document_loaders/docling) | 多种文件类型（见 https://ds4sd.github.io/docling/） |
| [`PolarisAIDataInsightLoader`](/oss/integrations/document_loaders/polaris_ai_datainsight) | 多种文件类型（见 https://datainsight.polarisoffice.com/documentation?docType=doc_extract） |
