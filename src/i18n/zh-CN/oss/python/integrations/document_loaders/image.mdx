...
它使用 [Unstructured](https://unstructured.io/) 来处理多种图像格式，例如 `.jpg` 和 `.png`。有关在本地设置 Unstructured 的更多说明，包括设置必需的系统依赖项，请参阅 [Unstructured](/oss/integrations/providers/unstructured/)。
