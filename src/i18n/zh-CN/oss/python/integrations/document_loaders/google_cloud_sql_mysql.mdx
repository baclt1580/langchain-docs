...
本笔记本介绍如何使用 [Cloud SQL for MySQL](https://cloud.google.com/sql/mysql) 通过 `MySQLLoader` 和 `MySQLDocumentSaver` 来[保存、加载和删除 LangChain 文档](/oss/integrations/document_loaders)。
