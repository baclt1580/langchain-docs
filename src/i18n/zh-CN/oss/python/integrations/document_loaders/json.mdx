...
本指南提供了快速入门 `JSONLoader` [文档加载器](/oss/integrations/document_loaders) 的简要概述。有关 `JSONLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/json_loader/JSONLoader)。
