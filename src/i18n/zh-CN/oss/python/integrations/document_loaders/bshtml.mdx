...
本指南提供了快速入门 BeautifulSoup4 [文档加载器](/oss/integrations/document_loaders) 的概述。有关 BeautifulSoup4 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/python/langchain-community/document_loaders/html_bs/BSHTMLLoader)。
