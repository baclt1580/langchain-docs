...
这将帮助您开始使用 SQL 数据库 [工具包](/oss/integrations/tools/sql_database)。有关所有 `SQLDatabaseToolkit` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-community/agent_toolkits/sql/toolkit/SQLDatabaseToolkit)。
...
遵循 [SQL 问答教程](/oss/langchain/sql-agent)，下面我们为我们的简单问答代理配备工具包中的工具。首先，我们拉取一个相关的提示词并用其所需参数填充它：
