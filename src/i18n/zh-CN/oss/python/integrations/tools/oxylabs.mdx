...
设置正确的 API 密钥和环境变量。创建您的 API 用户凭据：在 [Oxylabs 仪表板](https://dashboard.oxylabs.io/en/registration) 注册免费试用或购买产品以创建您的 API 用户凭据（OXYLABS_USERNAME 和 OXYLABS_PASSWORD）。
