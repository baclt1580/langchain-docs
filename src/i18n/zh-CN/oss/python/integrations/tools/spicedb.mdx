...
<Tip>
    这些工具需要一个正在运行的 SpiceDB 实例。请参阅 [SpiceDB 提供者页面](/oss/integrations/providers/spicedb) 获取设置说明。
</Tip>
...
- [SpiceDB 提供者概述](/oss/integrations/providers/spicedb)
- [SpiceDB 检索器](/oss/integrations/retrievers/spicedb)