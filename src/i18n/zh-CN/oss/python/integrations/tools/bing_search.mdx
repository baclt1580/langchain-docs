...
我们在此展示如何将其作为 [agent](/oss/langchain/agents) 的一部分使用。我们使用 OpenAI Functions Agent，因此我们需要为此设置并安装所需的依赖项。我们还将使用 [LangSmith Hub](https://smith.langchain.com/hub) 来获取提示词，因此我们需要安装它。
