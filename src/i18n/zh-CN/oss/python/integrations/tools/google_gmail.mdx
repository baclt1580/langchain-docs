...
这将帮助您开始使用 Gmail [工具包](/oss/integrations/tools/google_gmail)。此工具包与 Gmail API 交互，用于读取邮件、起草和发送邮件等。有关所有 `GmailToolkit` 功能和配置的详细文档，请前往 [API 参考](https://reference.langchain.com/python/langchain-google-community/gmail/toolkit/GmailToolkit)。
