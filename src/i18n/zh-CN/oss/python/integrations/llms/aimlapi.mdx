...
<Warning>
**您当前所在的页面是关于将 AI/ML API 模型用作文本补全模型的文档。许多最新和最流行的 AI/ML API 模型是 [聊天完成模型](/oss/langchain/models)。**

您可能正在寻找 [此页面](/oss/integrations/chat/aimlapi)。
</Warning>
...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output) | [图像输入](/oss/langchain/messages#multimodal) | 音频输入 | 视频输入 | [Token 级流式传输](/oss/langchain/streaming/) | 原生异步 | [Token 用量](/oss/langchain/models#token-usage) | [日志概率](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
