...
<Warning>
**您当前所在的页面是关于使用 OpenAI 文本补全模型的文档。最新且最受欢迎的 OpenAI 模型是 [聊天完成模型](/oss/langchain/models)。**

除非您专门在使用 gpt-3.5-turbo-instruct，否则您可能正在寻找 [此页面](/oss/integrations/chat/openai/)。
</Warning>
...
有关所有 @[`OpenAI`] llm 功能和配置的详细文档，请访问 API 参考：[reference.langchain.com/python/langchain-openai/llms/base/OpenAI](https://reference.langchain.com/python/langchain-openai/llms/base/OpenAI)