...
本指南提供了快速入门 `AlibabaCloudMySQL` [向量存储](/oss/integrations/vectorstores#overview) 的概述。有关所有 alibabacloud-mysql 向量存储功能、参数和配置的详细列表，请前往 [langchain-alibabacloud-mysql](https://github.com/wangkuahai/langchain-alibabacloud-mysql)。
