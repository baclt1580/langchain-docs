...
<Note>
    ...
    有关 CLI 存储约定，请参阅 [应用数据](/oss/deepagents/data-locations)。
...
当你使用 [子智能体](/oss/deepagents/subagents) 时，可以配置每种类型可以访问哪些技能：
...
有关子智能体配置和技能继承的更多信息，请参阅 [子智能体](/oss/deepagents/subagents)。
