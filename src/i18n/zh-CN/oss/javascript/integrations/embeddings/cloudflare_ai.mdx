...
本文将帮助您开始使用 LangChain 结合 Cloudflare Workers AI 的[嵌入模型](/oss/integrations/embeddings)。有关 `CloudflareWorkersAIEmbeddings` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-cloudflare/CloudflareWorkersAIEmbeddings)。
...
以下是一个使用 Workers AI 嵌入与 [Cloudflare Vectorize 向量存储](/oss/integrations/vectorstores/cloudflare_vectorize/)的 Worker 示例。
