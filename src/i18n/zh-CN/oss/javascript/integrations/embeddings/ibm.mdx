...
本文将帮助您开始使用 LangChain 集成 IBM watsonx.ai 的[嵌入模型](/oss/integrations/embeddings)。有关 `IBM watsonx.ai` 功能和配置选项的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/embeddings/ibm/WatsonxEmbeddings)。
