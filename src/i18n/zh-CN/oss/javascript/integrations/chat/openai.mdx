...
<Note>
    **Chat 完成 API 兼容性**
    ...
    `ChatOpenAI` 完全兼容 OpenAI 的（遗留）[Chat 完成 API](https://platform.openai.com/docs/guides/completions)。如果您正在寻找连接到支持 Chat 完成 API 的其他模型提供商的方法，您可以这样做——参见 [说明](/oss/integrations/chat#chat-completions-api)。
</Note>
...
| [工具调用](/oss/langchain/tools) | [结构化输出](/oss/langchain/structured-output) | [图像输入](/oss/langchain/messages#multimodal) | 音频输入 | 视频输入 | [Token 级流式传输](/oss/langchain/streaming/) | [Token 用量](/oss/langchain/models#token-usage) | [Logprobs](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ |
...
注意，响应包含结构化的 [内容块](/oss/langchain/messages/#message-content)，其中包括响应文本和 OpenAI [引用](https://platform.openai.com/docs/guides/tools-web-search?api-mode=responses#output-and-citations) 来源。输出消息还将包含任何工具调用的信息。
