...
<Warning>
您当前浏览的页面是介绍将 Mistral 模型用作文本补全模型的文档。Mistral 上提供的许多热门模型是[聊天补全模型](/oss/langchain/models)。

您可能正在寻找[此页面](/oss/integrations/chat/mistral/)。
</Warning>

<Tip>
**想要在本地运行 Mistral 的模型？请查看我们的 [Ollama 集成](/oss/integrations/chat/ollama)。**
</Tip>
