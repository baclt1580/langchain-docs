...
<Warning>
**您当前浏览的是 OpenAI 文本补全模型的文档页面。最新且最受欢迎的 OpenAI 模型是 [聊天补全模型](/oss/langchain/models)。**

除非您明确在使用 `gpt-3.5-turbo-instruct`，否则您可能应该查看 [此页面](/oss/integrations/chat/openai/)。
</Warning>
...
如果您在 Azure OpenAI 上托管，请参阅 [专用页面](/oss/integrations/llms/azure)。
