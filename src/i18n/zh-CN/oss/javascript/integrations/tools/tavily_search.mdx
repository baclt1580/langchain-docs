...
本指南提供了 Tavily [工具](/oss/integrations/tools/) 的快速入门概览。关于 Tavily 工具的完整说明，您可以在 [API 参考](https://reference.langchain.com/javascript/langchain-tavily/TavilySearch) 中找到更详细的文档。
...
我们可以通过先将工具绑定到一个 [工具调用模型](/oss/langchain/tools/)，然后在链中调用它来使用我们的工具：
