...
本指南提供了快速入门 `SerpAPI` [工具](/oss/integrations/tools/) 的概述。有关 `SerpAPI` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/tools/serpapi/SerpAPI)。
