...
本笔记本提供了快速入门 `DuckDuckGoSearch` [工具](/oss/integrations/tools/) 的概述。有关 `DuckDuckGoSearch` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/tools/duckduckgo_search/DuckDuckGoSearch)。
