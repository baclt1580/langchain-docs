...
- 使用 [`OracleTextSplitter`](/oss/integrations/document_loaders/file_loaders/oracleai#chunk-documents) 进行分块和规范化
- 使用 [`OracleEmbeddings`](/oss/integrations/embeddings/oracleai) 生成嵌入，并将其存储在 [`OracleVS`](/oss/integrations/vectorstores/oracleai) 中
