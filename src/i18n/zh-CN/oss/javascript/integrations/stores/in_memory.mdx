...
本文将帮助您开始使用 [InMemoryStore](/oss/integrations/stores)。有关 `InMemoryStore` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-core/stores/InMemoryStore)。
