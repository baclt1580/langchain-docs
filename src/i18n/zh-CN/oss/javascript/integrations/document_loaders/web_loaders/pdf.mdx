...
本笔记本提供了快速入门 `WebPDFLoader` [文档加载器](/oss/integrations/document_loaders/) 的概述。有关 `WebPDFLoader` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/document_loaders/web/pdf/WebPDFLoader)。
