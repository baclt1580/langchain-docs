...
本文将帮助您开始使用 `AzionRetriever` [检索](/oss/langchain/retrieval)。有关 `AzionRetriever` 所有功能和配置的详细文档，请参阅 [API 参考](https://reference.langchain.com/javascript/langchain-community/retrievers/azion_edgesql/AzionRetriever)。
