...
sidebarTitle: 使用服务器 API 实现人机协同
---

要在智能体或工作流中审查、编辑和批准工具调用，请使用 LangGraph 的[人机协同](/oss/langgraph/interrupts)功能。
...
* [人机协同概念指南](/oss/langgraph/interrupts)：深入了解 LangGraph 人机协同功能。
