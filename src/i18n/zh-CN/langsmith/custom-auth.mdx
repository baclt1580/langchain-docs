...
本指南将展示如何为您的 LangSmith 应用添加自定义身份验证。本页的步骤适用于 [云端](/langsmith/cloud) 和 [自托管](/langsmith/self-hosted) 两种部署方式。它不适用于在您自己的自定义服务器中独立使用 [LangGraph 开源库](/oss/langgraph/overview) 的情况。
