...
更多信息请参阅 `langchain` 的 @[Python][BaseChatModel.with_retry] 和 [JS](https://reference.langchain.com/javascript/langchain-core/language_models/chat_models/BaseChatModel/withRetry) API 参考文档。
