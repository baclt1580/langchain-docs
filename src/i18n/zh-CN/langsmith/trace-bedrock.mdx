...
本指南展示了如何使用原生 AWS SDK 配合 LangSmith 追踪 [Amazon Bedrock](https://aws.amazon.com/bedrock) 模型调用。LangSmith 也能与 [LangChain 的 Bedrock 集成](/oss/integrations/providers/aws) 无缝协作。两种方法都能提供以下洞察：
...
- 查看 [LangChain Bedrock 集成文档](/oss/integrations/chat/bedrock) 了解高级功能，如扩展思维和引用